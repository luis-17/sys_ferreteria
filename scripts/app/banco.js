angular.module('theme.banco', ['theme.core.services'])
  .controller('bancoController', ['$scope', '$sce', '$uibModal', '$bootbox', '$window', '$http', '$theme', '$log', '$timeout', 'uiGridConstants', 'pinesNotifications', 
    'bancoServices',
    ...
    $scope.gridOptions = {
      ...
      multiSelect: true,
      columnDefs: [
        { field: 'id', name: 'idbanco', displayName: 'ID', maxWidth: 80,  sort: { direction: uiGridConstants.DESC} },
        { field: 'descripcion', name: 'descripcion_banco', displayName: 'Descripción' }
      ],
      onRegisterApi: function(gridApi) { 
        ...
        $scope.gridApi.core.on.filterChanged( $scope, function(grid, searchColumns) {
          ...
          paginationOptions.searchColumn = { 
            ...
            'descripcion_banco' : grid.columns[2].filters[0].term,
          }
          $scope.getPaginationServerSide();
        });
      }
  ...
  .service("bancoServices",function($http, $q) {
    ...
    function sListarBancosCbo(pDatos) { 
      var datos = pDatos || {};
      var request = $http({
        method : "post",
        url : angular.patchURLCI+"Banco/lista_banco_cbo", 
        data : datos 
      });
