angular.module('theme.medioPagoFarmacia', ['theme.core.services'])
  .controller('medioPagoFarmaciaController', ['$scope', '$sce', '$modal', '$bootbox', '$window', '$http', '$theme', '$log', '$timeout', 'uiGridConstants', 'pinesNotifications', 'hotkeys', 'medioPagoFarmaciaServices',
    function($scope, $sce, $modal, $bootbox, $window, $http, $theme, $log, $timeout, uiGridConstants, pinesNotifications,hotkeys, medioPagoFarmaciaServices){
    'use strict';
    shortcut.remove("F2"); $scope.modulo = 'medioPagoFarmacia';
