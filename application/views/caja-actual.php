...
<div class="container-fluid" ng-controller="cajaActualController"> 
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-danger" data-widget='{"id" : "wiget10000"}'>
              ...
              <div class="panel-body">
                <div ng-show="cajaAbiertaPorMiSession || !(fSessionCI.key_group == 'key_caja')">
                  <ul class="row demo-btns">
                      ...
                      <li class="form-group mt-sm col-sm-6 p-n pull-right text-right mr-n" > 
                        <button ng-if="cajaAbiertaPorMiSession" type="button" class="btn btn-primary-alt btn-lg" ng-click="goToUrl('/nueva-venta');" > <i class="ti ti-file"></i> NUEVA VENTA </button> 
                        <button ng-if="cajaAbiertaPorMiSession" type="button" class="btn btn-inverse btn-lg" ng-click="cerrarCaja();" > <i class="ti ti-close"></i> CERRAR CAJA </button> 
                        ...
                        <div class="panel-heading">
                          ...
                          <h2>
                            <ul class="nav nav-tabs">
                              <li class="active">
                                <a data-target="#home" href="" data-toggle="tab" ng-click="reloadGrid();">Ventas <!-- de Caja Actual --> </a> 
                              </li>
                              <li><a data-target="#tab2" href="" data-toggle="tab" ng-click="reloadGrid();">Ventas Anuladas <!-- de Caja Actual --> <label class="label label-danger" style="margin: 7px;opacity: 0.5;"> <i class="fa fa-ban"></i> </label> </a></li>
                              <li><a data-target="#tab3" href="" data-toggle="tab" ng-click="reloadGrid();"> Ventas con Dscto. <!-- <label class="label label-warning" style="margin: 7px;opacity: 0.5;"> <i class="fa fa-spinner"></i> </label> --> </a></li>
                              <li><a data-target="#tab4" href="" data-toggle="tab" ng-click="reloadGrid();"> Productos por Venta <label class="label label-info" style="margin: 7px;opacity: 0.5;"> <i class="fa fa-star"></i> </label> </a></li>
                              <li><a data-target="#tab5" href="" data-toggle="tab" ng-click="reloadGrid();"> Solicitudes de Impresión <!-- <label class="label label-warning" style="margin: 7px;opacity: 0.5;"> <i class="fa fa-print"></i> </label> --> </a></li>
                            </ul>
                          </h2>
                        </div>
                        <div class="panel-body">
                          <div class="tab-content">
                            <div class="tab-pane active" id="home"> 
                              ...
                              <ul class="form-group demo-btns col-xs-12">
                                ...
                                <li class="pull-right" ng-if="mySelectionGridV.length > 0 && cajaAbiertaPorMiSession" ><button type="button" class="btn btn-danger" ng-click='btnAnular();'>Anular</button></li>
                                <!-- <li class="pull-right" ng-if="mySelectionGridV.length > 0 && cajaAbiertaPorMiSession" ><button type="button" class="btn btn-warning" ng-click='btnSolicitudImprimirTicket();'> <i class="fa fa-share"> </i> Solicitar Re-impresión </button></li> -->
                              ...
                              <div ui-grid="gridOptions" ui-grid-pagination ui-grid-selection ui-grid-resize-columns ui-grid-move-columns ui-grid-auto-resize class="grid table-responsive">
                            ...
                            <div class="tab-pane" id="tab2">
                              ...
                              <div ui-grid="gridOptionsVentasAnuladas" ui-grid-pagination ui-grid-selection ui-grid-resize-columns ui-grid-move-columns ui-grid-auto-resize class="grid table-responsive">
                            ...
                            <div class="tab-pane" id="tab3"> 
                              ...
                              <div ui-grid="gridOptionsVentasEnEspera" ui-grid-pagination ui-grid-selection ui-grid-resize-columns ui-grid-move-columns ui-grid-auto-resize class="grid table-responsive">
                            ...
                            <div class="tab-pane" id="tab4"> 
                              ...
                              <div ui-grid="gridOptionsProductosVenta" ui-grid-pagination ui-grid-selection ui-grid-resize-columns ui-grid-move-columns ui-grid-auto-resize class="grid table-responsive">
                            ...
                            <div class="tab-pane" id="tab5"> 
                              ...
                              <div ui-grid="gridOptionsVentasImpresion" ui-grid-pagination ui-grid-selection ui-grid-resize-columns ui-grid-move-columns ui-grid-auto-resize class="grid table-responsive">
                ...
                <div ng-show="!cajaAbiertaPorMiSession && (fSessionCI.key_group == 'key_caja')" class="text-center"> <!--  -->
