<ol class="breadcrumb">
  ...
  <li>Mantenimiento</li>
  <li class="active">Almacenes Farmacia</li>
</ol>
<div class="container-fluid" ng-controller="almacenFarmController">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-danger" data-widget='{"id" : "wiget10000"}'>
              <div class="panel-heading">
                <div class="panel-ctrls button-icon" data-actions-container="" data-action-collapse='{"target": ".panel-body"}' data-action-colorpicker=''> </div>
                <h2>Gestión de Almacenes Farmacia</h2>
              </div>
              ...
              <div class="panel-body">
                <ul class="form-group demo-btns">
                    ...
                    <li class="pull-right" ng-if="mySelectionGrid.length == 1" ><button type="button" class="btn btn-primary" ng-click='btnAgregarSubAlmacen()'>Agregar SubAlmacen</button></li>
