...
<div class="container-fluid" ng-controller="ventaImpresionFarController">
    <div class="row">
        <div class="col-md-12">
              ...
              <div class="panel-body">
                <div ng-show="cajaAbiertaPorMiSession || !(fSessionCI.key_group == 'key_caja')">
                  <ul class="row demo-btns">
                      ...
                      <li class="form-group mr mt-sm col-sm-2 p-n" > <label>  </label> 
                        <button type="button" ng-click="getPaginationIMServerSide();" class="btn btn-info"> PROCESAR </button>
                      </li>
