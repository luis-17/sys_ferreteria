        ...
        <div class="panel-body">
          <ul class="form-group demo-btns">
              ...
              <!-- <li class="pull-right" ng-if="mySelectionGrid.length > 0" ><button type="button" class="btn btn-danger" ng-click='btnAnular()'>Anular</button></li> -->
               <li class="pull-right" ng-if="mySelectionGrid.length > 0 " ><button type="button" class="btn btn-warning" ng-click='btnRechazarMuestra()'>RECHAZAR MUESTRA</button></li>
              <li class="pull-right" ng-if="mySelectionGrid.length > 0 " ><button type="button" class="btn btn-info" ng-click='btnGenerar("lg")'>GENERAR EXAMEN</button></li>
