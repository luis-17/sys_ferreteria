            ...
            <div class="panel panel-danger" data-widget='{"id" : "wiget10000"}'>
              ...
              <div class="panel-body">
                <ul class="form-group demo-btns">
                    ...
                    <li class="pull-right" ng-if="mySelectionGrid.length == 1"><button type="button" class="btn btn-midnightblue" ng-click='btnAgregarRol()'>Roles</button></li>
                    <li class="pull-right"><button type="button" class="btn btn-success" ng-click='btnNuevo()'>Nuevo</button></li>
                </ul>
                <div ui-grid="gridOptions" ui-grid-pagination ui-grid-selection ui-grid-resize-columns ui-grid-move-columns class="grid table-responsive list-grupos"></div>
              </div>
            </div>
        </div>
    </div>
