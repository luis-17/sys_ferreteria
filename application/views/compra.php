...
<div class="container-fluid" ng-controller="compraController"> 
  <div class="row">
      <div class="col-md-12">
          <div class="panel panel-danger" data-widget='{"id" : "wiget10000"}'>
            <div class="panel-heading">
              <div class="panel-ctrls button-icon" data-actions-container="" data-action-collapse='{"target": ".panel-body"}' data-action-colorpicker=''> </div>
              <h2> Compras por Servicio </h2>
            </div>
              ...
              <form name="formCompras" novalidate>
                <div class="row">
                  <div class="col-xs-12 form-inline mb">  
                    ...
                    <div class="form-group"> <label class="m-n"> OPERACIÓN </label> 
                      <select class="form-control input-sm block" ng-model="fBusqueda.operacion" ng-change="procesar(); $event.preventDefault();" ng-options="item as item.descripcion for item in metodos.listaOperaciones" > </select>
                    </div> 
                    <div class="form-group ml" style="vertical-align: bottom;"> 
                      <input type="button" class="btn btn-info" value="PROCESAR" ng-click="procesar(); $event.preventDefault();" tabindex="7" ng-disabled="formCompras.$invalid" /> 
                    </div>
                    <div class="form-group" ng-show="fBusqueda.operacion.id == 1" style="vertical-align: bottom;"> 
                      <input type="button" class="btn btn-info" value="REPORTE E.M.A" ng-click="verPopupReporteTerceros(); $event.preventDefault();" tabindex="7" ng-disabled="formCompras.$invalid" /> 
                    </div>
                    <div class="form-group" style="vertical-align: bottom;"> 
                      <button type="button" class="btn btn-primary" ng-click="exportarExcel(); $event.preventDefault();" tabindex="7" ng-disabled="formCompras.$invalid"><i class="fa fa-file-excel-o"></i> </button> 
                    </div>
                  </div>
                </div>
              </form>
                    ...
                    <div class="panel-heading">
                      <h2>
                        <ul class="nav nav-tabs">
                          <li class="active"> <a data-target="#tab1" href="" data-toggle="tab" > Listado de Compras </a> </li>
                          <li><a data-target="#tab2" href="" data-toggle="tab" > Detalle de Compras 
                        ...
                        <div class="tab-pane active" id="tab1"> 
                          <ul class="form-group demo-btns col-xs-12" style="padding-top: 10px; border-top: 1px solid #ddd;">
                            ...
                            <li class="pull-right" ng-if="mySelectionGridES.length == 1"> 
                                <button type="button" class="btn btn-danger" ng-click='btnAnularCompra();'> <i class="fa fa-times-circle"> </i> Anular Compra </button>
                            </li>
                            <li class="pull-right">
                            ...
                            <li class="pull-right" ng-if="mySelectionGridES.length == 1">
                              <button type="button" class="btn btn-primary" ng-click="btnAsientosContables();"> 
