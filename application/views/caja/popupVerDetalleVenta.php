...
<div class="modal-body">
	<div class="row">
		...
		<div class="form-group col-md-3 mb-md">
			...
			<p class="help-block mt-xs" style="font-weight: bold;"> {{ fVenta.cliente }} </p> 
		</div>
		<div class="form-group col-md-3 mb-md">
			<label class="control-label mb-n"> Fecha de Venta: </label>
			<p class="help-block mt-xs" style="font-weight: bold;"> {{ fVenta.fecha_venta }} </p> 
		</div>
		<div class="form-group mb-md col-xs-12">
			<ul class="form-group demo-btns">
                <li ><button class="btn btn-info" type="button" ng-click='btnToggleFiltering()'>Buscar</button></li> 
            </ul>
			<div ui-grid="gridOptionsDetalleVenta" ui-grid-pagination ui-grid-selection ui-grid-cellNav ui-grid-resize-columns class="grid table-responsive"></div> 
		</div>
	</div>
</div> 
