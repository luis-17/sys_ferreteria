...
<div class="modal-body">
    <form class="row" name="formPresentacion"> 
...
<div class="modal-footer">
    <button class="btn btn-primary" ng-click="aceptar(); $event.preventDefault();" ng-disabled="formPresentacion.$invalid">Aceptar</button>
