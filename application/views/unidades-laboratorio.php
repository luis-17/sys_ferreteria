<ol class="breadcrumb">
  ...
  <li class="active">Unidades de Laboratorio</li>
</ol>
<div class="container-fluid" ng-controller="unidadesLaboratorioController">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-danger" data-widget='{"id" : "wiget10000"}'>
              <div class="panel-heading">
                <div class="panel-ctrls button-icon" data-actions-container="" data-action-collapse='{"target": ".panel-body"}' data-action-colorpicker=''> </div>
                <h2>Gestión de Unidades de Laboratorio</h2>
              </div>
