...
<div class="container-fluid" ng-controller="egresoController"> 
  <div class="row">
      <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-xs-12 form-inline mb">  
                    ...
                    <div class="form-group" style="vertical-align: bottom;"> 
                      <button type="button" class="btn btn-primary" ng-click="exportarExcel(); $event.preventDefault();" tabindex="7" ng-disabled="formEgresos.$invalid"><i class="fa fa-file-excel-o"></i> </button> 
                    </div>
                  </div>
                </div>
              </form>
