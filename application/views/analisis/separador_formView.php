    ...
    <form class="row" name="formParametros">
    	<div class="col-md-12">
    		<div class="form-group mb-md col-md-6">
				<label class="control-label mb-xs"> Elegir un subnivel o parámetro</label>
			...
			<div class="row">
				 <div class="form-group col-xs-12 m-n">
                    <label class="control-label">Parámetros: </label>
                        <div ui-if="gridOptionsSepPar.data.length>0" 
                        ui-grid="gridOptionsSepPar" ui-grid-resize-columns ui-grid-auto-resize class="grid table-responsive" style="overflow: hidden;" ng-style="getTableHeight();"></div>
                </div>
			</div>
		</div>
	</form>
