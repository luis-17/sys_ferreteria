...
<div class="container-fluid" ng-controller="notaCreditoController">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-danger" data-widget='{"id" : "wiget10000"}'>
              ...
              <div class="panel-body">
                <ul class="row demo-btns">
                    <li class="form-group mr mt-sm col-md-3 col-sm-6 col-xs-12 p-n" > <label> Empresas / Sedes </label> 
                          ...
                          <div class="tab-pane active" id="home">
                            ...
                            <div class="col-md-2 col-xs-12">
                                <div class="text-right">
                                  <h4 class="well well-sm"> TOTAL <strong style="font-weight: 400; text-decoration: underline;" class="text-success"> : {{ gridOptions.sumTotal }} </strong> </h4>
                                </div>
                            </div>
                          </div>
                        </div>
