...
<div class="container-fluid" ng-controller="ventaDescuentoFarmController">
    <div class="row">
        <div class="col-md-12">
                ...
                <div ng-show="cajaAbiertaPorMiSession || !(fSessionCI.key_group == 'key_caja_far')">
                  <ul class="row demo-btns">
                      ...
                      <li class="form-group mr mt-sm col-sm-2 p-n" > <label> Cajas Abiertas </label> 
                        <select class="form-control input-sm" ng-model="fBusqueda.cajamaster" ng-change="getPaginationEEServerSide();" ng-options="item.id as item.descripcion for item in listaCajaMaster" > </select> 
                      </li>
                  </ul>
                  <div class="row">
                    <div class="col-md-12">
