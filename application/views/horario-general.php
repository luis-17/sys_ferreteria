<ol class="breadcrumb m-n">
  ...
  <li>RR.HH</li>
  <li class="active">Horario General</li>
</ol>
<div class="container-fluid" ng-controller="horarioGeneralController">
    <div class="row">
        <div class="col-md-12">
                  ...
                  <div class="col-lg-6 col-md-12 col-xs-12">
                    <ul class="form-group demo-btns">
                      ...
                      <li class="pull-right" >
                        ...
                        <button type="button" class="btn btn-danger" ng-click="btnAnularEmpleado();" ng-if="mySelectionGridEM.length == 1"> 
                          <i class="fa fa-file"></i> ANULAR EMPLEADO 
                        </button>
                      </li>
                    </ul>
                    <div class="row">
                    ...
                    <ul class="form-group demo-btns">
                        <li class="text-right block" style="height: 32px;"> 
                          <button type="button" class="btn btn-success" ng-click="btnNuevo();" ng-if="mySelectionGridEM.length == 1"> 
                            <i class="ti ti-timer"></i> HORARIO GENERAL 
                          </button>
                          <button type="button" class="btn btn-info" ng-click="btnActualizarMarcado();" ng-if="mySelectionGridEM.length == 1"> 
                            <i class="fa fa-file"></i> ACTUALIZAR MARCACIONES 
                          </button>
                          <button type="button" class="btn btn-danger" ng-click="btnAnularHorario();" ng-if="mySelectionGridEM.length == 1 && mySelectionGridHG.length >= 1"> 
                            <i class="fa fa-file"></i> ANULAR HORARIO 
                          </button>
                        </li>
                    </ul>
