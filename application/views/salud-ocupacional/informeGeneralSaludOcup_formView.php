...
<div class="modal-body">
	<form class="row" name="formInformeGeneral">
	    <div class="col-xs-12" style="line-height: 1.1; font-size: 95%;">
	      <fieldset class="row">
	        <legend class="col-xs-12  mb-sm pb-n" style="font-weight: bold; font-size: 14px; border: none;"> 
	          <div class="block" style="background-color: #5d7581; color: white; text-align: center; line-height: 1.5;"> SERVICIO </div>
	        </legend> 
	        <div class="col-xs-12 form-inline mb-sm pl-xs"> 
	          ...
	          <div class="form-group col-md-3 col-sm-6 col-xs-12 mb-xs" >
	            <div class="mb-n">
	              <label for="inputHelpBlock" class="m-n text-blue"> Perfil </label>
	            </div>
...
<div class="modal-footer">
    <button class="btn btn-primary" ng-click="aceptar(); $event.preventDefault();" ng-disabled="formInformeGeneral.$invalid">Aceptar</button>
