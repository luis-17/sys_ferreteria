...
<div class="container-fluid" ng-controller="ctCajaChicaController">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-danger" data-widget='{"id" : "wiget10000"}'>
              ...
              <div class="panel-body">
                <ul class="form-group demo-btns">
                    ...
                    <li class="pull-right" ng-if="mySelectionGrid.length == 1"><button type="button" class="btn btn-inverse" ng-click='btnAsignar()'>Asignar Caja</button></li>
