...
class DocumentoInterno extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->helper(array('security','fechas_helper'));
		$this->load->model(array('model_documento_interno'));
		//cache
	...
	public function lista_documentos_internos_intranet()
	{
		$allInputs = json_decode(trim(file_get_contents('php://input')),true);
		$lista = $this->model_documento_interno->m_cargar_documento_interno_intranet();
		$arrListado = array();
		foreach ($lista as $row) { 
			...
			array_push($arrListado,
				array(
					'id' => $row['iddocumentointerno'],
					'idsedeempresaadmin' => $row['idsedeempresaadmin'],
					'nombre_documento' => strtoupper($row['nombre_documento']),
					'empleado' => $row['empleado'],
					'fecha_subida' => formatoConDiaYano($row['fecha_subida']),
					'archivo' => array(
	...
	public function lista_documentos_internos()
	{
		$allInputs = json_decode(trim(file_get_contents('php://input')),true);
